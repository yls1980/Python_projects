...
a.append(point_0)
v1 = sd.get_vector(start_point=point_0, angle=120, length=200)
a.append(v1.end_point)
v2 = sd.get_vector(start_point=v1.end_point, angle=240, length=200)
a.append(v2.end_point)


v1= sd.lines(a,sd.COLOR_DARK_RED,True, 5)
